...
import com.colsanitas.loginadmin.administracion.web.ConsultarUsuarioWeb;
import com.colsanitas.loginadmin.dto.DatosPrestadorDTO;
import com.osi.his.sistema.util.finder.AbstractFinder;

@Name("prestadorFinder")
@Scope(ScopeType.CONVERSATION)
public class PrestadorFinder extends AbstractFinder<PrestadorView>implements Serializable {
	...
	private ConsultarUsuarioWeb consultarUsuarioWeb;
	...
	public void findByCode(PrestadorView entity) {
		...
		try {
			if( entity != null ) {
				...
				if( consultarUsuarioWeb != null && consultarUsuarioWeb.getTipoDocSel() != null ){
					tipoDoc = consultarUsuarioWeb.getTipoDocSel();
				} 
